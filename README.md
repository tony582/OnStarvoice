...
> 本文是**架构与开发总览**。另见:运营操作 [`docs/用户操作手册.md`](docs/用户操作手册.md) · 接口参考 [`docs/API接口文档.md`](docs/API接口文档.md) · 部署运维 [`deploy/DEPLOY.md`](deploy/DEPLOY.md) · 扩展维护交接 [`docs/extension-maintenance-handoff.md`](docs/extension-maintenance-handoff.md)。
