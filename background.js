...
importScripts(
  ...
  'utils/capture/lifecycle/leases.js',
  'utils/capture/lifecycle/restore.js',
  'utils/capture/lifecycle/admission.js',
  'utils/capture/lifecycle/begin.js',
  'utils/capture/lifecycle/progress.js',
  'utils/capture/lifecycle/cleanup.js',
  'utils/capture/lifecycle/attempts.js',
  'utils/capture/lifecycle/end.js',
  'utils/capture/lifecycle/tabs.js',
  'utils/capture/lifecycle/coordinator.js',
);
...
async function inspectUnattendedLocalClosurePredicate(
  ...
  const state = {
    ...
    taskSessionPresent: Boolean(
      taskGroup ||
      isCaptureTaskCleanupInProgress(taskId),
    ),
...
const captureLifecycle = globalThis.OnStarvoiceCaptureLifecycle.create({
  ...
  buildUnattendedCaptureTaskId,
  captureRuntimeSnapshotMatches,
  captureTaskTabGroupApi,
  chrome,
  console,
  debugSessionApi: globalThis.OnStarvoiceCaptureDebugSession,
  ...
  setTimeout,
  taskOwnerApi: globalThis.OnStarvoiceCaptureTaskOwner,
  taskRunActivityAt,
  taskRuntimeApi: globalThis.OnStarvoiceCaptureTaskRuntime,
  taskTabGroupApi: globalThis.OnStarvoiceCaptureTaskTabGroup,
...
const {
  ...
  runCaptureTaskLifecycleOperation,
  setCaptureTaskMinimized,
  updateCaptureTask,
  writeCaptureTaskCancellationFailSoft,
  isCaptureTaskCleanupInProgress,
  debugSessions: captureDebugSessionManager,
  tabGroups: captureTaskTabGroupManager,
  owners: captureTaskOwnerCoordinator,
} = captureLifecycle;
