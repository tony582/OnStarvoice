...
import captureDiscoveriesRouter from './routes/capture-discoveries.js';
import androidControlRouter from './routes/android-control.js';
import captureDiscoveryManagementRouter from './routes/capture-discovery-management.js';
...
export function createApp({ corsOrigins, health, healthProvider, logger = console } = {}) {
  ...
  app.use('/api/capture-cloud/android', androidControlRouter);
  app.use('/api/capture-cloud', captureDiscoveryManagementRouter);
  app.use('/api/capture-cloud', captureDiscoveriesRouter);
