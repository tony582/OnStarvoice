...
import {evaluateActiveStopAuthority} from '../services/capture-stop-authority.js';

export function createCaptureStopAuthorityRouter({evaluate = evaluateActiveStopAuthority} = {}) {
  const router = Router();
  router.post('/agent/stop-authority', async (req, res, next) => {
...
export default createCaptureStopAuthorityRouter();
