...
async function renderTriage() {
  ...
  const statusTabs = [
    ...
    { value: 'privacy_unreachable', label: '隐私限制-无法触达' },
  ...
  return `<div class="action-group">
    ...
    <div class="action-dropdown">
      ...
      <div class="action-menu">
        ...
        <button onclick="updateTriage('${escAttr(r.id)}','privacy_unreachable'); this.closest('.action-dropdown').classList.remove('open')">隐私限制-无法触达</button>
