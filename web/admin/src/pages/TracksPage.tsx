...
function TrackDrawer({ track, onClose }: { track: any; onClose: () => void }) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-end" onClick={onClose}>
      ...
      <div role="dialog" aria-modal="true" aria-label="赛道策略"
        ...
        <div className="flex items-center justify-between border-b border-border px-4 py-4 sm:px-6">
          ...
          <button onClick={onClose} aria-label="关闭赛道策略" className="rounded-lg p-2 text-muted-foreground transition hover:bg-accent"><X className="h-5 w-5" /></button>
        </div>
