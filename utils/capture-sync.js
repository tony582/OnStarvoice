import {createResultDeliveryPipeline} from './capture/delivery/coordinator.js';
...
// Compose once after host constants initialize; existing exports/callers retain their names.
// No new queue, network call, collection, or storage write is performed by assembly.
const resultDelivery = createResultDeliveryPipeline({
