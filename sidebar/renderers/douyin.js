...
export function buildDouyinCardData(record, payload, hydratedSinglePayload) {
  if (hydratedSinglePayload) {
    return buildSingleNoteCardData(hydratedSinglePayload, "douyin");
  }

  if (record.type === "single_note") {
    return buildSingleNoteCardData(payload, "douyin");
  }
